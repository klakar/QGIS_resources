...
sources.append(["connections-xyz","Open Topo Map", "", "", "OpenStreetMap contributors, CC-BY-SA, SRTM", "https://{s}.tile.opentopomap.org/{z}/{x}/{y}.png", "", "17", "0"])
sources.append(["connections-xyz","NASAGIBS Vis Earth Night", "", "", "Imagery provided by services from the Global Imagery Browse Services (GIBS), operated by the NASA/GSFC/Earth Science Data and Information System with funding provided by NASA/HQ.", "https://map1.vis.earthdata.nasa.gov/wmts-webmerc/VIIRS_CityLights_2012/default/{time}/{tilematrixset}{maxZoom}/{z}/{y}/{x}.{format}", "", "8", "1"])
